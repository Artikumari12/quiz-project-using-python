...
def create_database():
    ...
    # Insert sample data
    sample_data = [
        ("What is the capital of INdia?", "Patna","Madhayapardesh","Uttarpardesh","Delhi","Mumbai"),
        ("What is the largest lake in the world?", "Caspian Sea", "Baikal", "Lake Superior", "Ontario", ),
        ("Who wrote the novel War and peace?", "Anton Checkhov", "Fyodor Dostoevsky", "Leo Tolstoy", "Ivan Turgenev", "Pacific"),
